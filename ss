...
local Shadowyx = Instance.new("ScreenGui")
Shadowyx.Name = "Shadow Hub"
Shadowyx.Parent = game.CoreGui
Shadowyx.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
wait(.6)
TweenService:Create(Barload,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundTransparency = 0}):Play()
TweenService:Create(LoadText,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextTransparency = 0}):Play()
TweenService:Create(LoadTitle,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextTransparency = 0}):Play()
wait(.6)
...
if game.PlaceId == 2753915549 then
    ...
    LoadText.Text = "Blox Fruits First Sea"
    Wait(1.5)
elseif game.PlaceId == 4442272183 then
    Barload:TweenSize(UDim2.new(0, 250,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
    LoadText.Text = "Blox Fruits Second Sea"
    Wait(1.5)
elseif game.PlaceId == 7449423635 then
    Barload:TweenSize(UDim2.new(0, 250,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
    LoadText.Text = "Blox Fruits Third Sea"
    Wait(1.5)
end
Barload:TweenSize(UDim2.new(0, 250,0, 2), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
...
LoadText.Text = "Ready!"
Wait(1.5)
TweenService:Create(Barload,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{BackgroundTransparency = 1}):Play()
TweenService:Create(LoadText,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextTransparency = 1}):Play()
TweenService:Create(LoadTitle,TweenInfo.new(.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{TextTransparency = 1}):Play()
wait(.6)
WindowStroke1:Destroy()
LoadFrame:TweenSize(UDim2.new(0, 0,0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, .6, true)
wait(2)

local ShadowyScreen = Instance.new("ScreenGui")
local ShadowyToggleUI = Instance.new("TextButton")
local ShadowyCornerUI = Instance.new("UICorner")
local ShadowyImageUI = Instance.new("ImageLabel")

ShadowyScreen.Name = "ShadowyScreen"
ShadowyScreen.Parent = game.CoreGui
ShadowyScreen.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

ShadowyToggleUI.Name = "ShadowyToggleUI"
ShadowyToggleUI.Parent = ShadowyScreen
ShadowyToggleUI.BackgroundColor3 = Color3.fromRGB(20,20,20)
ShadowyToggleUI.BorderSizePixel = 0
ShadowyToggleUI.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
ShadowyToggleUI.Size = UDim2.new(0, 50, 0, 50)
ShadowyToggleUI.Font = Enum.Font.SourceSans
ShadowyToggleUI.Text = ""
ShadowyToggleUI.TextColor3 = Color3.fromRGB(0, 0, 0)
ShadowyToggleUI.TextSize = 14.000
ShadowyToggleUI.Draggable = true
ShadowyToggleUI.MouseButton1Click:Connect(function()
    game:GetService("VirtualInputManager"):SendKeyEvent(true,305,false,game)
    game:GetService("VirtualInputManager"):SendKeyEvent(false,305,false,game)
end)

ShadowyCornerUI.Name = "ShadowyCornerUI"
ShadowyCornerUI.Parent = ShadowyToggleUI

ShadowyImageUI.Name = "ShadowToggleXD"
ShadowyImageUI.Parent = ShadowyToggleUI
ShadowyImageUI.BackgroundColor3 = Color3.fromRGB(20,20,20)
ShadowyImageUI.BackgroundTransparency = 1.000
ShadowyImageUI.BorderSizePixel = 0
ShadowyImageUI.Position = UDim2.new(0.0, 0, 0.0, 0)
ShadowyImageUI.Size = UDim2.new(0, 50, 0, 50)
ShadowyImageUI.Image = "http://www.roblox.com/asset/?id=11705592065"

if game:GetService("CoreGui"):FindFirstChild("Shadowy GUI") then
	game:GetService("CoreGui"):FindFirstChild("Shadowy GUI"):Destroy()
end
...
local Shadowy = Instance.new("ScreenGui")
Shadowy.Name = "Shadowy GUI"
Shadowy.Parent = game:GetService("CoreGui")
Shadowy.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

local NotiScreen = Instance.new("ScreenGui")
NotiScreen.Name = "Shadowy Notification"
NotiScreen.Parent = game:GetService("CoreGui")
NotiScreen.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

function ShadowyLib:Window(text,mainclr,cls)
	...
	UserInputService.InputBegan:Connect(function(input)
		if input.KeyCode == CloseBind then
			if uitoggled == false then
				...
				uitoggled = true
				Shadowy.Enabled = false
			else
				Shadowy.Enabled = true
	...
	function ShadowyLib:Notification(titletext, desctext, btntext)
