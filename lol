-- // [ Shadow UI Library Edit.]

if game:GetService("CoreGui"):FindFirstChild("Shadow GUI") then
    game:GetService("CoreGui"):FindFirstChild("Shadow GUI"):Destroy()
end
...
function ShadowLib:Window(text,mainclr,cls)
	...
	function ShadowLib:Notification(titletext, desctext, btntext)
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text,ico)
			...
			function ChannelContent:Seperator(text)
				...
				Seperator.Parent = ChannelHolder
				...
				Sep2.Position = UDim2.new(0, 147, 0, 0)
				...
				Sep3.BackgroundColor3 = PresetColor
