...
function library:CreateWindow(name, hidebutton)
    ...
    window.NameLabel.Position = UDim2.fromOffset(5, -1)
...
--[[
	...
	Logo.Name = "Logo"
	Logo.Parent = window.TopBar
	Logo.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
	Logo.BackgroundTransparency = 1.000
	Logo.Position = UDim2.new(0, 5, 0, 1)
	Logo.Size = UDim2.new(0, 19, 0, 19)
	Logo.Image = "http://www.roblox.com/asset/?id=9591850663"
]]
    if _G.ColorP == "RGB" then
        spawn(function()
            while wait() do
    ...
    function window:CreateTab(name)
        ...
        function tab:CreateSector(name, side)
            ...
            function sector:AddLabelP(text)
                local label = { }
                label.Main = Instance.new("TextLabel", sector.Items)
                label.Main.Name = "Label"
                label.Main.BackgroundTransparency = 1
                ...
                label.Main.Font = window.theme.font
                label.Main.Text = text
                label.Main.TextColor3 = Color3.fromRGB(0, 254, 216)
